...
namespace FlashCardsLib
{
    public class German : ILanguage
    {
        ...
        {
            public string Typename => typeof(German.Noun).Name;
        ...
        {
            public string Typename => typeof(German.Adjective).Name;
            public Language Language => LANGUAGE;
        ...
        {
            public string Typename => typeof(German.Preposition).Name;
            public Language Language => LANGUAGE;
        }

        public class Conjunction : IWordtype
        {
            public string Typename => typeof(German.Conjunction).Name;
            public Language Language => LANGUAGE;
            //weil, sondern, wegen
        }
